...
exec "hi Character guifg=#ff0000 guibg=NONE gui=NONE ctermfg=208"
...
exec "hi Cursor guifg=". s:dark_gray.gui ." guibg=". s:purple.gui ." gui=NONE ctermfg=NONE ctermbg=241"
